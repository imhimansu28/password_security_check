...
def freeze(
    ...
    skip_match = re.compile(skip_regex).search if skip_regex else None
...
def get_requirement_info(dist):
    ...
    if vcs_backend is None:
        ...
        comments = [f'# Editable install with no version control ({req})']
    ...
    try:
        ...
        req = dist.as_requirement()
        comments = [
            f'# Editable {type(vcs_backend).__name__} install with no remote ({req})'
        ]
