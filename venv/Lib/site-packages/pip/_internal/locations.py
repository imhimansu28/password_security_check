...
def distutils_scheme(dist_name, user=False, home=None, root=None,
    ...
    dist_args = {'name': dist_name} | extra_dist_args
    ...
    assert not user or not prefix, f"user={user} prefix={prefix}"
    assert not home or not prefix, f"home={home} prefix={prefix}"
    ...
    if 'install_lib' in d.get_option_dict('install'):  # type: ignore
        scheme |= dict(purelib=i.install_lib, platlib=i.install_lib)
