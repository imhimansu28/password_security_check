...
def _get_html_page(link, session=None):
    ...
    except (_NotHTTP, _NotHTML, HTTPError):
        logger.debug(
...
class LinkEvaluator(object):
    ...
    def evaluate_link(self, link):
        ...
        if link.egg_fragment:
            ...
            if ext == WHEEL_EXTENSION:
                ...
                if not wheel.supported(supported_tags):
                    ...
                    reason = f"none of the wheel's tags match: {', '.join(file_tags)}"
                    return (False, reason)
        ...
        if "source" not in self._formats and ext != WHEEL_EXTENSION:
            return False, f'No sources permitted for {self.project_name}'
        ...
        if not version:
            return False, f'Missing project version for {self.project_name}'
