...
def process_line(
    ...
    line_comes_from = (
        f"{'-c' if constraint else '-r'} {filename} (line {line_number})"
    )
    ...
    if args_str:
        ...
        req_options = {
            dest: opts.__dict__[dest]
            for dest in SUPPORTED_OPTIONS_REQ_DEST
            if dest in opts.__dict__ and opts.__dict__[dest]
        }

        line_source = f'line {line_number} of {filename}'
        ...
        for host in opts.trusted_hosts or []:
            source = f'line {line_number} of {filename}'
